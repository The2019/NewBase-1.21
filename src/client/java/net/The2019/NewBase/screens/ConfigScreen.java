...
public class ConfigScreen extends Screen {
    ...
    @Override
    protected void init() {
        this.addDrawable(new TextWidget(x, 20, 100, 20, Text.translatable("newbase.configscreen.name").formatted(Formatting.BOLD), textRenderer)).setTooltip(Tooltip.of(Text.translatable("newbase.configscreen.nametooltip")));
        ...
        //Render
        this.addDrawable(new TextWidget(x, y + 30, 100, 20, Text.translatable("newbase.configscreen.render"), mc.textRenderer));
        ...
        //Generic
        this.addDrawable(new TextWidget(x, y + 60, 100, 20, Text.translatable("newbase.configscreen.generic"), mc.textRenderer));
